...
<div class="container">
  ...
  <div class="nav-scroller py-1 mb-3 border-bottom">
    <nav class="nav nav-underline justify-content-between">
      ...
      <?php displayRekomendasiKategori(); ?>
    </nav>
  </div>
</div>
...
<main class="container">
  ...
  <div class="row g-5">
    <div class="col-md-8">
      ...
      <?php displayNewPost($page); ?>
      

      <nav class="blog-pagination" aria-label="Pagination">
        <a class="btn btn-outline-primary rounded-pill" href="<?php echo '?p='.$page+1; ?>">Older</a>
        <?php 
        if($page - 1 < 0){
        echo '<a class="btn btn-outline-secondary rounded-pill disabled" aria-disabled="true">Newer</a>';
        }else{
           echo "<a class='btn btn-outline-secondary rounded-pill' href='?p=".($page - 1) ."'>Newer</a>";
        }
        ?>
      </nav>
